...
def get_args():
    ...
    parser.add_argument('--project_name', default='CSAGC-GZ', type=str)
    parser.add_argument('--gpu_ids', type=str, default='4,5', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='checkpoints/', type=str)
    #parser.add_argument('--checkpoint_root', default='val/', type=str)
    parser.add_argument('--output_folder', default='vis/CSAGC-GZ', type=str)
    ...
    parser.add_argument('--net_G', default='Net7', type=str,
